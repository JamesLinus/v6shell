...
: "	as usual.							"
:
: "	In  the  normal  case, an interrupt signal received by the	"
: "	shell during execution of either file causes it  to  cease	"
: "	execution  of  that  file.   This  does  not terminate the	"
: "	shell.  If desired, the trap special command can  be  used	"
: "	to ignore interrupts and other signals.				"
:
